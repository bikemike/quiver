...
// Minimal implementations to satisfy linker/compiler
Quiver::Quiver(std::list<std::string> &images, bool bRecursive) {}
Quiver::~Quiver() {}
void Quiver::Init() {}
...
gboolean Quiver::EventDelete(GtkWidget *w, GdkEvent *e, gpointer d) { return TRUE; }
gboolean Quiver::event_delete(GtkWidget *w, GdkEvent *e, gpointer d) { return TRUE; }
